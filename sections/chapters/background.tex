...
large number of operations in parallel. They also have a large memory
...
and may not be ready to be scheduled. If there is not enough warps inflight
...
\cite{CUDAStream} presented a performance model for CUDA streams for the
